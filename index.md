...
1.게임 오브젝트 분해
  ...
  |속성|영문명칭|설명|예시사진|
  |:----:|:-----:|:-------:|:----:|
  |체력|hp|플레이어 또는 적의 체력바|![그림](ahffn.github.io./img/hp.png)|
  |카드|card|플레이어가 사용할 수 있는 무기|![그림](./img/card.png)|
  |주사위|dice|카드에 넣어 사용할 수 있는 주사위 1~6이 아닌 다른 숫자도 있을 수 있다.|![그림](./img/주사위 예시.png)|
  |적|enemy|플레이어가 싸워야하는 적|![그림](./img/enemy.png)|
